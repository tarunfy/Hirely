  ...
  return (
    <div className="flex flex-col justify-start items-center pt-28 px-16 bg-slate-50 h-screen w-full">
      <div className="top flex justify-between items-center w-full">
        ...
        <button className="uppercase font-semibold border-[1px] hover:scale-95 hover:bg-secondary-500 hover:text-white hover:shadow-xl hover:shadow-secondary-300 transition-all ease-in-out duration-300 flex items-center border-secondary-500 text-xl px-5 py-2 text-secondary-500">
