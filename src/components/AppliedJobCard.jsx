...
const AppliedJobCard = ({ job }) => {
  return (
    <div className="relative px-3 py-10 bg-white shadow-md hover:shadow-xl hover:-translate-y-1 transition-all ease-in-out duration-300 w-full h-56  rounded-sm">
      ...
      <div className="absolute cursor-default bottom-2 font-medium right-2">
        <Tippy content="Status" inertia animation="scale">
          <p className="group relative inline-flex border border-secondary-600 focus:outline-none  lg:ml-4 lg:inline-flex">
            <span className="w-full inline-flex items-center justify-center self-stretch px-2 py-1 text-sm text-secondary-600 text-center font-medium uppercase bg-white ring-1 ring-secondary-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
